...
- You are at least 13 years of age (or the minimum age of digital consent in your jurisdiction), or you have parental/guardian consent to use the App.
- If you are under the age of 18 (or the age of majority in your jurisdiction), you represent that your parent or legal guardian has reviewed and agrees to these Terms on your behalf.
- You have read, understood, and agree to be bound by these Terms and our [Privacy Policy](privacy-policy.md).
...
- The accuracy of translations, text recognition (OCR), spell-check suggestions, or text-to-speech pronunciation
- The effectiveness of the spaced repetition algorithm or any study method employed by the App
...
- Redistribute, republish, or make the App available on any other platform or app store
- Use the App in any way that could damage, disable, overburden, or impair any third-party service accessed through the App
...
- Does not infringe upon any third party's intellectual property rights, privacy rights, publicity rights, or any other legal rights
...
- You are not violating any copyright, trademark, or other intellectual property rights
...
- We do not control, endorse, or assume responsibility for any third-party service
...
- **MERCHANTABILITY** — the App may not be suitable for your particular purpose
- **FITNESS FOR A PARTICULAR PURPOSE** — we make no guarantee the App will meet your specific requirements
- **NON-INFRINGEMENT** — we cannot guarantee the App does not inadvertently infringe third-party rights
- **ACCURACY OR RELIABILITY** — translations, OCR results, spell-check suggestions, and any other output of the App or third-party services are provided for informational purposes only and may contain errors
- **AVAILABILITY** — we do not guarantee uninterrupted or error-free operation
- **SECURITY** — we do not guarantee the security of data stored on your device
- **COMPATIBILITY** — we do not guarantee compatibility with all devices, operating systems, or third-party applications
- **WARRANTIES ARISING FROM COURSE OF DEALING, COURSE OF PERFORMANCE, OR USAGE OF TRADE**
- **WARRANTIES THAT THE APP WILL BE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS**

YOU ACKNOWLEDGE THAT:

- Translations generated by the App (via Google ML Kit or any other means) may be inaccurate, incomplete, or misleading. You should not rely on them for critical, legal, medical, safety, or professional purposes.
- OCR (optical character recognition) results may contain errors due to image quality, font variations, or other factors.
...
- Any risks of inaccurate translations, incorrect spell-check suggestions, or erroneous OCR results
- Any risks of data loss, corruption, or degradation, regardless of cause
- Any reliance on content generated by, imported into, or stored within the App
...
- Loss of data, study progress, or User Content
- Loss of profits, revenue, or business opportunities
- Loss of use or functionality
- Loss of goodwill
- Damages arising from reliance on translations, OCR, spell-check, or any other App output
- Damages arising from the use or inability to use the App
- Damages arising from unauthorized access to your data
- Damages arising from third-party services accessed through the App
- Damages arising from device malfunction, corruption, or loss
- Damage to your device or other software
- Emotional distress or any other intangible losses
...
- Any dispute between you and a third-party service provider
...
- Modifying file format compatibility
- Updating third-party service integrations
